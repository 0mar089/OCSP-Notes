...
* **Puerto 22/TCP (SSH):** Servicio OpenSSH para acceso remoto por terminal. Ver teoría en [[Pentesting Notes/1_Enumeration/SSH|SSH.md]].
* **Puerto 80/TCP (HTTP):** Servidor web HTTP en ejecución. Ver teoría en [[Pentesting Notes/1_Enumeration/HTTP & HTTPS|HTTP & HTTPS.md]].
...
Ver guía y sintaxis de filtrado en [[Pentesting Notes/Web/Fuzzing/FFUF|FFUF.md]].
...
**Puerto 9000:**
![[Pasted image 20260818161058.png]]
...
* **Teoría:** [[Pentesting Notes/Web/Vulnerabilities/03-SSRF/Cheat Sheet|SSRF Cheat Sheet]], [[Pentesting Notes/Web/Fuzzing/FFUF|FFUF.md]], [[Pentesting Notes/1_Enumeration/HTTP & HTTPS|HTTP & HTTPS.md]], [[Pentesting Notes/1_Enumeration/SSH|SSH.md]], [[Pentesting Notes/3_Post-Explotation/Linux Privilage Escalation/Permissions|Linux Privilege Escalation - Permissions.md]]
* **Laboratorios Relacionados:** [[Laboratorios/Vulnyx/Facil/Swamp|Swamp]] (Comparte resolución por VHosts y análisis de archivos JavaScript), [[Laboratorios/DockerLabs/Facil/Gotham|Gotham]] (Comparte interacción con paneles y explotación de endpoints vulnerables)
