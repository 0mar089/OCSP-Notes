...
![Pasted image 20260818231631.png](../../../assets/Pasted%20image%2020260818231631.png)
...
* **Puerto 80/TCP (HTTP):** Servidor web Apache httpd 2.4.62. Ver teoría en [HTTP & HTTPS.md](../../../Pentesting%20Notes/1_Enumeration/HTTP%20%26%20HTTPS.md).
...
![Pasted image 20260818231739.png](../../../assets/Pasted%20image%2020260818231739.png)

Accedemos a través del navegador a `http://bola.nyx`, encontrándonos con la página corporativa principal:

![Pasted image 20260818231608.png](../../../assets/Pasted%20image%2020260818231608.png)

Al explorar las rutas accesibles, localizamos un formulario de inicio de sesión en `/login/login.php`:

![Pasted image 20260818232215.png](../../../assets/Pasted%20image%2020260818232215.png)
...
![Pasted image 20260818232205.png](../../../assets/Pasted%20image%2020260818232205.png)
...
![Pasted image 20260818232623.png](../../../assets/Pasted%20image%2020260818232623.png)
...
![Pasted image 20260819000356.png](../../../assets/Pasted%20image%2020260819000356.png)
...
1. **Endpoint `/.well-known/openid-configuration`:**
   Al consultar este recurso en formato JSON, identificamos una fuga de nombres de usuarios registrados en el sistema:

   ```text
   http://bola.nyx/.well-known/openid-configuration
   ```

   ![Pasted image 20260819000727.png](../../../assets/Pasted%20image%2020260819000727.png)
...
2. **Endpoint `/.well-known/security.txt`:**
   Contiene información sobre las políticas y contactos de seguridad, confirmando el correo corporativo del usuario `jackie0x17`:

   ```text
   http://bola.nyx/.well-known/security.txt
   ```

   ![Pasted image 20260819000806.png](../../../assets/Pasted%20image%2020260819000806.png)
...
![Pasted image 20260819002831.png](../../../assets/Pasted%20image%2020260819002831.png)
...
![Pasted image 20260820022031.png](../../../assets/Pasted%20image%2020260820022031.png)
...
![Pasted image 20260820022112.png](../../../assets/Pasted%20image%2020260820022112.png)
...
![Pasted image 20260820022309.png](../../../assets/Pasted%20image%2020260820022309.png)
...
![Pasted image 20260820022459.png](../../../assets/Pasted%20image%2020260820022459.png)
...
![Pasted image 20260820023916.png](../../../assets/Pasted%20image%2020260820023916.png)

Intentamos descargar `http://bola.nyx/download.php?file_name=4a8f81d01d65d3468955191045816c85.pdf`:

![Pasted image 20260820024013.png](../../../assets/Pasted%20image%2020260820024013.png)
...
![Pasted image 20260820024130.png](../../../assets/Pasted%20image%2020260820024130.png)

Solicitamos la descarga de `http://bola.nyx/download.php?file_name=97035ded598faa2ce8ff63f7f9dd3b70.pdf`:

![Pasted image 20260820024117.png](../../../assets/Pasted%20image%2020260820024117.png)
...
![Pasted image 20260820030214.png](../../../assets/Pasted%20image%2020260820030214.png)
...
![Pasted image 20260820030303.png](../../../assets/Pasted%20image%2020260820030303.png)
...
![Pasted image 20260820030532.png](../../../assets/Pasted%20image%2020260820030532.png)

Accedemos a `http://localhost:9000` desde el navegador para verificar la disponibilidad del servicio:

![Pasted image 20260820030601.png](../../../assets/Pasted%20image%2020260820030601.png)
...
![Pasted image 20260820032203.png](../../../assets/Pasted%20image%2020260820032203.png)
...
![Pasted image 20260820032224.png](../../../assets/Pasted%20image%2020260820032224.png)
...
![Pasted image 20260820033556.png](../../../assets/Pasted%20image%2020260820033556.png)
...
* **Teoría:** [HTTP & HTTPS.md](../../../Pentesting%20Notes/1_Enumeration/HTTP%20%26%20HTTPS.md), [SSH.md](../../../Pentesting%20Notes/1_Enumeration/SSH.md), [Fuzzing Cheat Sheet](../../../Pentesting%20Notes/Web/Fuzzing/Cheat%20Sheet.md), [Linux Privilege Escalation - Permissions.md](../../../Pentesting%20Notes/3_Post-Explotation/Linux%20Privilage%20Escalation/Permissions.md)
* **Laboratorios Relacionados:** [Express](../../../Laboratorios/Vulnyx/Medio/Express.md) (Comparte resolución por VHosts, descubrimiento de servicios internos en puerto 9000 y escalada a root), [Internal](../../../Laboratorios/DockerLabs/Facil/Internal.md) (Comparte port forwarding y explotación de servicios locales)
