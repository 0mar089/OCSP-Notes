...
![Pasted image 20260701212945.png](../../../assets/Pasted%20image%2020260701212945.png)
...
![Pasted image 20260701213101.png](../../../assets/Pasted%20image%2020260701213101.png)

whatweb no reporta tecnologías o CMS adicionales de interés:

![Pasted image 20260701213107.png](../../../assets/Pasted%20image%2020260701213107.png)
...
![Pasted image 20260701214629.png](../../../assets/Pasted%20image%2020260701214629.png)
...
![Pasted image 20260701214656.png](../../../assets/Pasted%20image%2020260701214656.png)
...
![Pasted image 20260701213407.png](../../../assets/Pasted%20image%2020260701213407.png)

* **Hallazgo:** Identificamos un directorio `/images` que contiene una imagen llamada `agua_ssh.jpg`:

![Pasted image 20260701213445.png](../../../assets/Pasted%20image%2020260701213445.png)
...
![Pasted image 20260701214807.png](../../../assets/Pasted%20image%2020260701214807.png)
...
![Pasted image 20260701214858.png](../../../assets/Pasted%20image%2020260701214858.png)

* **Vulnerabilidad de Configuración:** El usuario `agua` puede ejecutar la herramienta `/usr/bin/bettercap` como `root` sin necesidad de ingresar una contraseña (NOPASSWD). Ver teoría en [Permissions.md](../../../Pentesting%20Notes/3_Post-Explotation/Linux%20Privilage%20Escalation/Permissions.md).
...
![Pasted image 20260701215249.png](../../../assets/Pasted%20image%2020260701215249.png)
...
![Pasted image 20260701215540.png](../../../assets/Pasted%20image%2020260701215540.png)
...
* **Laboratorios Relacionados:** [Duque](../../../Laboratorios/DockerLabs/Facil/Duque.md) (Comparte escalada por explotación indirecta de SUID), [Patriaquerida](../../../Laboratorios/DockerLabs/Facil/Patriaquerida.md) (Comparte escalada por binarios SUID)
