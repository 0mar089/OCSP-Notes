...
* **Vulnerabilidad de Configuración:** Detectamos que el binario `/usr/bin/python3.8` tiene el bit SUID habilitado. Ver teoría en [[Pentesting Notes/3_Post-Explotation/Linux Privilage Escalation/Permissions\|Permissions.md]].
...
* **Laboratorios Relacionados:** [[Laboratorios/DockerLabs/Facil/Patriaquerida\|Patriaquerida]] (Comparte exactamente la misma escalada por Python SUID)
