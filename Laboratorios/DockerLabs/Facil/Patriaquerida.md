...
![Pasted image 20260630232140.png](../../../assets/Pasted%20image%2020260630232140.png)
...
![Pasted image 20260630232240.png](../../../assets/Pasted%20image%2020260630232240.png)

El servidor nos muestra la página por defecto de Apache:

![Pasted image 20260630232308.png](../../../assets/Pasted%20image%2020260630232308.png)

### Fuzzing de Directorios (ffuf)
Realizamos fuzzing de archivos y directorios con ffuf, identificando el archivo `index.php`:

![Pasted image 20260630232934.png](../../../assets/Pasted%20image%2020260630232934.png)

![Pasted image 20260630232951.png](../../../assets/Pasted%20image%2020260630232951.png)
...
![Pasted image 20260630233000.png](../../../assets/Pasted%20image%2020260630233000.png)
...
![Pasted image 20260630235046.png](../../../assets/Pasted%20image%2020260630235046.png)
...
![Pasted image 20260630235021.png](../../../assets/Pasted%20image%2020260630235021.png)

* **Hallazgo:** Confirmamos la vulnerabilidad de LFI. Al leer `/etc/passwd`, identificamos dos posibles usuarios en el sistema: `pinguino` y `mario`. Ver teoría sobre inyecciones de rutas en [Path Traversal Cheat Sheet](../../../Pentesting%20Notes/Web/Vulnerabilities/02-Path_Traversal/Cheat%20Sheet.md).
...
![Pasted image 20260630235159.png](../../../assets/Pasted%20image%2020260630235159.png)
...
![Pasted image 20260630235302.png](../../../assets/Pasted%20image%2020260630235302.png)
...
![Pasted image 20260630235418.png](../../../assets/Pasted%20image%2020260630235418.png)
...
![Pasted image 20260630235625.png](../../../assets/Pasted%20image%2020260630235625.png)

* **Vulnerabilidad de Configuración:** El intérprete de Python `/usr/bin/python3.8` tiene asignado el bit SUID. Ver teoría en [Permissions.md](../../../Pentesting%20Notes/3_Post-Explotation/Linux%20Privilage%20Escalation/Permissions.md).
...
* **Teoría:** [Path Traversal Cheat Sheet](../../../Pentesting%20Notes/Web/Vulnerabilities/02-Path_Traversal/Cheat%20Sheet.md), [Linux Privilege Escalation - Permissions.md](../../../Pentesting%20Notes/3_Post-Explotation/Linux%20Privilage%20Escalation/Permissions.md), [SSH.md](../../../Pentesting%20Notes/1_Enumeration/SSH.md)
