...
![Pasted image 20260214175919.png](../../../assets/Pasted%20image%2020260214175919.png)

**Servicios identificados:**
* **Puerto 22/TCP (SSH):** Puerto abierto para control remoto seguro. Ver teoría en [SSH.md](../../../Pentesting%20Notes/1_Enumeration/SSH.md).
...
![Pasted image 20260214180028.png](../../../assets/Pasted%20image%2020260214180028.png)
...
![Pasted image 20260214180110.png](../../../assets/Pasted%20image%2020260214180110.png)
...
![Pasted image 20260214182642.png](../../../assets/Pasted%20image%2020260214182642.png)

Fuzzeamos la ruta /javascript encontrada:

![Pasted image 20260214182710.png](../../../assets/Pasted%20image%2020260214182710.png)

Y repetimos la búsqueda de recursos hasta obtener códigos de respuesta exitosos (200 OK):

![Pasted image 20260214182730.png](../../../assets/Pasted%20image%2020260214182730.png)
...
![Pasted image 20260214183345.png](../../../assets/Pasted%20image%2020260214183345.png)
...
![Pasted image 20260214183820.png](../../../assets/Pasted%20image%2020260214183820.png)
...
![Pasted image 20260214183941.png](../../../assets/Pasted%20image%2020260214183941.png)
...
![Pasted image 20260214184020.png](../../../assets/Pasted%20image%2020260214184020.png)

* **Vulnerabilidad de Configuración:** El usuario juan tiene permisos para ejecutar el intérprete de programación /usr/bin/ruby con máximos privilegios (root) sin ingresar contraseña (NOPASSWD). Ver teoría en [Permissions.md](../../../Pentesting%20Notes/3_Post-Explotation/Linux%20Privilage%20Escalation/Permissions.md).
...
![Pasted image 20260214184109.png](../../../assets/Pasted%20image%2020260214184109.png)
...
* **Laboratorios Relacionados:** [Hedgehog](../../../Laboratorios/DockerLabs/MuyFacil/Hedgehog.md) (Pivotaje de usuarios), [Elevator](../../../Laboratorios/DockerLabs/Facil/Elevator.md) (Comparte pivotaje por ruby)