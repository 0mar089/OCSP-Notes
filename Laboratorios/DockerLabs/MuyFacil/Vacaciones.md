...
* **Puerto 22/TCP (SSH):** Puerto abierto para control remoto seguro. Ver teoría en [SSH.md](<../../../Pentesting Notes/1_Enumeration/SSH.md>).
...
* **Laboratorios Relacionados:** [Hedgehog](Hedgehog.md) (Pivotaje de usuarios), [Elevator](../Facil/Elevator.md) (Comparte pivotaje por ruby)
