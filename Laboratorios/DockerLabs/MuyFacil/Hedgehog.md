...
* **Puerto 22/TCP (SSH):** Servicio de acceso seguro SSH abierto. Ver teoría en [SSH.md](<../../../Pentesting Notes/1_Enumeration/SSH.md>).
* **Puerto 80/TCP (HTTP):** Servidor web expuesto en el puerto estándar. Ver teoría en [HTTP & HTTPS.md](<../../../Pentesting Notes/1_Enumeration/HTTP & HTTPS.md>).
...
* **Laboratorios Relacionados:** [Vacaciones](Vacaciones.md) (Usa pivotaje de usuarios)
